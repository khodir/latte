...
class OpenTelemetry::Exporter::OTLP::Exporter
  ...
  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#124
  def around_request; end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#380
  def as_otlp_any_value(value); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#372
  def as_otlp_key_value(key, value); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#313
  def as_otlp_span(span_data); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#361
  def as_otlp_span_kind(kind); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#353
  def as_otlp_status_code(code); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#251
  def backoff?(retry_count:, reason:, retry_after: T.unsafe(nil)); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#277
  ...
  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#106
  def http_connection(uri, ssl_verify_mode, certificate_file, client_certificate_file, client_key_file); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#233
  def log_request_failure(response_code); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#222
  ...
  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#426
  def parse_headers(raw); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#398
  def prepare_endpoint(endpoint); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#413
  def prepare_headers(config_headers); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#128
